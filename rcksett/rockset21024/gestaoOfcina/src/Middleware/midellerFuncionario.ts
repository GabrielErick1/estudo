...
async function authenticateFuncionarioByRole(request: FastifyRequest, reply: FastifyReply, roles: string[]): Promise<void> {
    try {
        ...
        (request as any).user = { id: user.id, tipo: user.tipo };
